  ...
  return (
    <>
        ...
        <div ref={printComponentRef} style={{direction: "rtl"}}>
            <h2 className="text-center font-bold text-2xl">فرم رضایت انجام خدمات لیزر</h2>
            ...
            <div className="mt-16">
                <table className="!w-full !border-[1px] !border-black">
                    <thead>
                        <tr>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">جلسه</th>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">نام اپراتور</th>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">تاریخ</th>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">ساعت شروع</th>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">ساعت پایان</th>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">LAZER POWER</th>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">PULSE WIDTH</th>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">FLUENCE J/CM2</th>
                            <th className="!border-[1px] !border-black text-center !font-bold py-4">مهر و امضای پزشک</th>
                        </tr>
                    </thead>
                    <tbody>
